...
#include "BTService_CheckGoToPlayerStatus.generated.h"


UCLASS()
class SPOOKYGAME_API UBTService_CheckGoToPlayerStatus : public UBTService
{
	GENERATED_BODY()

public:
	UBTService_CheckGoToPlayerStatus();
